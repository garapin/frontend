                ...
                <Box className="flex flex-col content-center">
                    ...
                    <Box className="h-min-screen flex flex-col justify-center bg-white">
                        ...
                        <Box className="overflow-hidden">
                            <Box className="hidden md:block md:absolute overflow-hidden top-0" sx={{width: {xl: '548px', md: '438px'}, height: {xl: '592px', md: '473px'}, left:{md: 'calc(100vw - 438px)', xl: 'calc(100vw - 548px)'}, background: 'rgba(113, 63, 151, 0.42)', borderRadius: '0px 0px 0px 50px'}} />
                            <Box className="hidden md:block md:absolute overflow-hidden top-0" sx={{width: {xl: '274px', md: '219px'}, height: {xl: '319px', md: '255px'}, left: {md: 'calc(100vw - 219px)', xl: 'calc(100vw - 274px)'}, background: '#9D28B1', borderRadius: '0px 0px 0px 50px'}} />
                            <Box className="hidden md:block md:absolute overflow-hidden " sx={{width: {xl: '627px', md: 'calc(0.33 * 100vw)'}, height: {xl: '413px', md: 'min(calc(0.38 * 100vh), calc(0.21 * 100vw))'}, left: 'calc(100vw * (1 - 0.40))', top: 'calc(0.1536 * 100vw)', borderRadius: '10px', boxShadow: '0px 0px 15px rgba(0, 0, 0, 0.15);'}}>
                                    <ImageCarousel 
                                        dataSource={imageSet} 
                                        maxHeight={413} maxWidth={627} 
                                        withThumbnail={false} 
                                        useMagnifier={false} 
                                        rsProps={{autoplay: true, autoplaySpeed: 4000, infinite: true}}
                                        className='py-0'
                                        sx={{width: {xl: '627px', md: 'calc(0.33 * 100vw)'}, height: {xl: '413px', md: 'min(calc(0.38 * 100vh), calc(0.21 * 100vw))'}}}
                                    />
                            </Box>
                        </Box>
                    </Box>
