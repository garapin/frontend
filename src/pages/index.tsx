                ...
                <Box className="flex flex-col content-center">
                    ...
                    <Box className="h-min-screen flex flex-col justify-center bg-white">
                            ...
                            <Box>
                                ...
                                <Box className="mt-28">
                                    ...
                                    <Box className="flex items-center mt-7">
                                        ...
                                        <svg width="216" height="48" viewBox="0 0 216 48" fill="none"
                                            xmlns="http://www.w3.org/2000/svg" className="mr-10">
                                            <path
                        ...
                        <Box className="overflow-hidden">
                            <Box className="hidden md:block md:absolute overflow-hidden top-0" sx={{
                                width: { xl: '548px', md: '438px' },
                                height: { xl: '592px', md: '473px' },
                                left: { md: 'calc(100vw - 438px)', xl: 'calc(100vw - 548px)' },
                            ...
                            <Box className="hidden md:block md:absolute overflow-hidden top-0" sx={{
                                ...
                                left: { md: 'calc(100vw - 219px)', xl: 'calc(100vw - 274px)' },
                                background: '#9D28B1',
                                borderRadius: '0px 0px 0px 50px'
                            }} />
                            <Box className="hidden md:block md:absolute overflow-hidden " sx={{
                                width: { xl: '627px', md: 'calc(0.33 * 100vw)' },
                                height: { xl: '413px', md: 'min(calc(0.38 * 100vh), calc(0.21 * 100vw))' },
                    ...
                    <Box className="h-min-screen flex flex-col items-center justify-between py-10 md:py-20"
                        sx={{ backgroundColor: '#F8F4F9' }}>
                        {/* <Trans t={t} i18nKey={'section2.header'}> */}
                        <Box className="max-w-xl xl:max-w-full pb-10 md:pb-20 px-4">
                            <Typography className="text-center" variant="h4" color="#713F97"
                                fontWeight="bold">{t('section2.header')}</Typography>
                        </Box>
                        {/* </Trans> */}
                        <Box className="flex flex-col md:flex-row items-center md:justify-around">
                            <Box className="flex flex-col items-center justify-center md:w-72 pb-10">
                                ...
                                <Typography variant="body1" color="text.primary"
                                    align="center">{t('section2.content.step1.content')}</Typography>
                            </Box>
                            <Box className="flex flex-col items-center justify-center md:w-72 pb-10">
                                <RoundedImage
                                    src="https://edit.co.uk/uploads/2016/12/Image-1-Alternatives-to-stock-photography-Thinkstock.jpg"
                                ...
                                <Typography variant="body1" color="text.primary"
                                    align="center">{t('section2.content.step2.content')}</Typography>
                            </Box>
                            <Box className="flex flex-col items-center justify-center md:w-72 pb-10">
                                <RoundedImage
                                    src="https://edit.co.uk/uploads/2016/12/Image-1-Alternatives-to-stock-photography-Thinkstock.jpg"
                                ...
                                <Typography variant="body1" color="text.primary"
                                    align="center">{t('section2.content.step3.content')}</Typography>
                            </Box>
                        </Box>
                    </Box>
                    ...
                    <Box
                        className="flex flex-col md:flex-row items-center justify-between py-10 md:py-20 md:px-60 bg-white">
                    ...
                    <Box className="flex flex-col items-center justify-around py-10 md:py-20 px-4 md:px-80"
                        sx={{ backgroundColor: '#F8F4F9' }}>
                        <Typography variant="h4" color="#713F97" className="pb-4 md:pb-20"
...
export const getServerSideProps = wrapper.getServerSideProps(store => async ({ locale }: { locale: string }) => {
